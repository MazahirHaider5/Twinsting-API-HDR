...
import { artistAvailability, artistBasicInformation, artistSkills, becomeArtist, getAllArtists, getArtistOrders, getLoggedInArtistDetails } from "../controllers/artist.controller";
...
router.get("/getAllArtists", requireAuth, getAllArtists);
